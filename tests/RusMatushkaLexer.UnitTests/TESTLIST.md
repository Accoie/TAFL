...
- [X] Разбор базовой программы: `НАЧАЛО СТРОКА словечко; ВНЕМЛИ(словечко); МОЛВИ(словечко) ИСХОД`
- [X] Разбор объявления переменных: `ЧИСЛО лета : цес = 25; ЧИСЛО пи : дробь = 3.14; СТРОКА имя = "Владимир"`
- [X] Разбор условного оператора: `ЕСЛИ (лета >= 18) СТАЛОБЫТЬ МОЛВИ("Здорово, ", имя); ИНО МОЛВИ("Мир тебе, ", имя);`
